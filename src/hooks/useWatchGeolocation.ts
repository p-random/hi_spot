...
/**
 * Continuously watches the user's GPS position using watchPosition().
 * Unlike the existing useGeolocation (button-triggered), this starts
 * tracking automatically on mount and keeps updating.
 */
export function useWatchGeolocation(): GeolocationState {
